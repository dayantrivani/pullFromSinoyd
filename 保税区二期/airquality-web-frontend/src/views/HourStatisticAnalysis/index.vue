  ...
  <el-card>
    ...
    <template slot="header">
      <el-form inline :model="queryForm">
        ...
        <el-form-item label="质量类别：">
          <el-select v-model="queryForm.psLevel" style="width: 125px" multiple collapse-tags>
            <el-option :value="1" label="优"></el-option>
            <el-option :value="2" label="良"></el-option>
            <el-option :value="3" label="轻度污染"></el-option>
            <el-option :value="4" label="中度污染"></el-option>
            <el-option :value="5" label="重度污染"></el-option>
            <el-option :value="6" label="严重污染"></el-option>
            <el-option :value="7" label="无效天"></el-option>
          </el-select>
        </el-form-item>
        <!-- 查询按钮 -->
        <el-form-item>
    ...
    >
      ...
      <el-table-column fixed label="监测点名称" align="center" width="120" prop="monitoringPointName" show-overflow-tooltip
      ></el-table-column>
      <el-table-column fixed label="日期" align="center" width="100" prop="datetime" show-overflow-tooltip>
      ...
      <el-table-column label="污染物浓度及空气质量指数（IAQI）" align="center">
        <el-table-column align="center" min-width="110">
          <!-- eslint-disable-next-line -->
          <template slot="header" slot-scope="{ row }">
            <span>PM<sub>2.5</sub>24小时平均值</span>
          </template>
        ...
        <el-table-column align="center">
          <!-- eslint-disable-next-line -->
          <template slot="header" slot-scope="{ row }">
            <span>PM<sub>10</sub>24小时平均值</span>
          </template>
          <el-table-column align="center" width="110">
            <!-- eslint-disable-next-line -->
            <template slot="header" slot-scope="{ row }">
        ...
        <el-table-column align="center" width="180">
          <!-- eslint-disable-next-line -->
          <template slot="header" slot-scope="{ row }">
            <span>二氧化氮(NO<sub>2</sub>)24小时平均值</span>
          </template>
        ...
        <el-table-column align="center" width="160">
          <!-- eslint-disable-next-line -->
          <template slot="header" slot-scope="{ row }">
            <span>二氧化硫(SO<sub>2</sub>)24小时平均值</span>
          </template>
          <el-table-column align="center" width="130">
            <!-- eslint-disable-next-line -->
            <template slot="header" slot-scope="{ row }">
        ...
        <el-table-column align="center" width="160">
          <!-- eslint-disable-next-line -->
          <template slot="header" slot-scope="{ row }">
            <span>臭氧(O<sub>3</sub>)最大8小时滑动平均值</span>
          </template>
          ...
          <el-table-column label="分指数" align="center" prop="max8HourO3_IAQI"></el-table-column>
        </el-table-column>
        <el-table-column align="center" width="160">
          <!-- eslint-disable-next-line -->
          <template slot="header" slot-scope="{ row }">
            <span>臭氧(O<sub>3</sub>)最大1小时平均值</span>
          </template>
          <el-table-column align="center" width="110">
            <!-- eslint-disable-next-line -->
            <template slot="header" slot-scope="{ row }">
          ...
          <el-table-column label="分指数" align="center" prop="maxOneHourO3_IAQI"></el-table-column>
        </el-table-column>
      </el-table-column>
      <!-- <el-table-column label="空气质量指数(AQI)" align="center" prop="aqivalue" width="110"></el-table-column>
      <el-table-column label="首要污染物" align="center" prop="primaryPollutant" width="100"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getItemList() {
      ...
      this.$http.post('airquality/dayAQI', this.queryForm, {
    ...
    onDownload() {
      ...
      // const { page, rows } = this.pager;
      this.$http.post('airquality/dayAQI/export', this.queryForm, {
        'responseType': 'blob',
    ...
    exportExcel(data) {
      ...
      const filename = `每日评价数据${new Date().toLocaleDateString()}.xls`;
