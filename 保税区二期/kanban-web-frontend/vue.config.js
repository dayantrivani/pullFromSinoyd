...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      // redis接口
      '/api/sinoyd-redis': {
        target: 'http://192.168.30.92:9092/api/sinoyd-redis',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-redis': '',
      ...
      '/api/sinoyd-eec': {
        ...
        target: 'http://192.168.30.92:9092/api/sinoyd-eec',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-eec': '',
      ...
      '/api/sinoyd-amcs': {
        ...
        target: 'http://192.168.30.92:9092/api/sinoyd-amcs',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-amcs': '',
      ...
      '/api/sinoyd-airquality': {
        ...
        target: 'http://192.168.30.92:9092/api/sinoyd-airquality',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-airquality': '',
      ...
      '/api/sinoyd-wryalarm': {
        ...
        target: 'http://192.168.30.92:9092/api/sinoyd-wryalarm',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-wryalarm': '',
