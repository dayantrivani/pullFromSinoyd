...
export default {
  ...
  computed: {
    ...
    sideMenu() {
      ...
      //     label: '泵站监测数据展示',
      //     parentId: '0',
      //     moduleUrl: 'VoyageFactorInfo',
      //     moduleCode: 'VoyageFactorInfo',
      //   },
      //   {
      //     label: '泵站基础信息',
      //     parentId: '0',
      //     moduleUrl: 'VoyageResultInfo',
      //     moduleCode: 'VoyageResultInfo',
      //   },
      //   {
      //     label: '泵站对应企业',
      //     parentId: '0',
      //     moduleUrl: 'VoyageTaskInfo',
      //     moduleCode: 'VoyageTaskInfo',
      //   },
      // ];
    },
    // 一件展开侧栏可展开层级
