...
-->
  ...
  <div class="mod-upload-pictrue" v-loading="loading">
    ...
    >
      ...
      <div class="el-upload__tip" slot="tip">请上传.jpg/.jpeg/.png/.gif类型文件</div>
      <div slot="file" slot-scope="{file}">
        <img class="el-upload-list__item-thumbnail" :src="file.url" alt="">
        <span class="el-upload-list__item-actions">
          <span
            class="el-upload-list__item-enlarge"
            @click="onClickEnlarge(file)"
          >
    ...
    <div class="picDialog" v-show="isShow">
      <div class="picShade">
        <img class="picBase64" :src="base64Content" alt="">
        <div class="shadeClose" @click="onCloseEnlarge"><i class="el-icon-close"></i></div>
      </div>
    </div>
  </div>
</template>
