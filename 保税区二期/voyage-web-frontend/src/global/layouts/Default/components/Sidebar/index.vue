...
export default {
  ...
  computed: {
    ...
    sideMenu() {
      ...
      //     label: '走航任务',
      //     parentId: '0',
      //     moduleUrl: 'NavigationTask',
      //     moduleCode: 'NavigationTask',
      //   },
      //   {
      //     label: '异常管理',
      //     parentId: '0',
      //     moduleUrl: 'ExcepManagement',
      //     moduleCode: 'ExcepManagement',
      //   },
      //   {
      //     label: '走航因子维护',
      //     parentId: '0',
      //     moduleUrl: 'NavigationFactor',
      //     moduleCode: 'NavigationFactor',
      //   },
      // ];
    },
    // 一件展开侧栏可展开层级
