...
import { getFleSuffix } from '@/libs/tools';

// /**
//  * @description 中文转拼音
//  * @param {String} zhStr 中文字符串
//  */
// let pinyinLib = '';
// // eslint-disable-next-line global-require
// if (config.plugin.pinyin) { pinyinLib = require('pinyin'); }
// export const pinyin = (str, option = {}) => {
//   if (pinyinLib) return 'Not configured pinyin';
//   return pinyinLib(str, {
