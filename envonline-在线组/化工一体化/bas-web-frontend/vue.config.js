...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      ...
      // 存储接口
      '/storage': {
        // target: 'http://192.168.30.92:9099/storage/',
      ...
      '/api/sinoyd-keypoints': {
        // target: 'http://192.168.30.92:9090/api/sinoyd-keypoints',
        target: 'http://192.168.11.65:9090/api/sinoyd-keypoints',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-keypoints': '',
      ...
      '/api/sinoyd-eec': {
        ...
        target: 'http://192.168.11.65:9090/api/sinoyd-eec',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-eec': '',
