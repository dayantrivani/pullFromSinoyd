<template>
  ...
  <dialog-modal
    ...
    <el-form ref="form" label-width="100px" :model="dialogModel" :rules="rules">
      ...
      <el-form-item label="因子名称：" prop="factorName" placeholder="请选择因子名称">
      ...
      <el-form-item label="是否显示：" prop="isShow">
        <el-tooltip :content="dialogModel.isShow ? '显示' : '不显示'" placement="top">
          <el-switch :disabled="!dialogModel.isEnabled" v-model="dialogModel.isShow"></el-switch>
        </el-tooltip>
      </el-form-item>
      <el-form-item label="是否启用：" prop="isEnabled">
        <el-tooltip :content="dialogModel.isEnabled ? '启用' : '停用'" placement="top">
          <el-switch v-model="dialogModel.isEnabled" @change="changeIsEnabled"></el-switch>
        </el-tooltip>
      </el-form-item>
  ...
  methods: {
    ...
    onClickSave() {
      ...
      if (id) {
        ...
        this.url = 'cfg/pageShowItem/batch';
