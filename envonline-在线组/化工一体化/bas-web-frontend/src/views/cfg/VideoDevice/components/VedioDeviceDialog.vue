<template>
  <dialog-modal ref="dialog" size="middle" :title="`${isEdit ? '编辑' : '新增'}摄像头装置`">
    <el-form
      ref="form"
    ...
    >
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="所属企业：" prop="psId" hint-down>
            <el-select v-model="itemModel.psId" autofocus filterable :disabled="itemModel.id">
              <el-option
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="设备状态：" prop="devStatus">
            <el-select v-model="itemModel.devStatus" autofocus>
              <el-option
                v-for="(item, key) in $enum.DevStatus"
                :key="key"
                :label="item"
                :value="key - 0"
              ></el-option>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="设备流端口：" prop="devStreamPort">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="设备端口：" prop="devPort">
            <el-input v-model="itemModel.devPort"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="设备用户名：" prop="devUser">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="webSocktIp地址：" prop="webSocktIp">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="生产型号：" prop="devModel">
            <el-input v-model="itemModel.devModel"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="webSockPort端口号：" prop="webSockPort">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="生产厂商：" prop="devManufactureName">
            <el-input v-model="itemModel.devManufactureName"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="设备的类型：" prop="devTypeId">
            <el-select v-model="itemModel.devTypeId" autofocus>
              <el-option v-for="(item, key) in $enum.DevType" :key="key" :label="item" :value="key"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24">
          <el-form-item label="设备描述：" prop="devDesc">
            <el-input type="textarea" v-model="itemModel.devDesc"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
