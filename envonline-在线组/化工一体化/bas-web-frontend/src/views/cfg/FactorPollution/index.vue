      ...
      <el-form inline :model="queryForm">
        <el-form-item label="因子类型：">
          <el-select v-model="queryForm.factorsType">
            ...
            <el-option v-for="(item, key) in $enum.FactorsTypeList" :key="key" :label="item" :value="key"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="所属类型：">
          <el-select v-model="queryForm.category">
            <el-option label="全部" value=""></el-option>
            <el-option v-for="(item, key) in $enum.CategoryList" :key="key" :label="item" :value="key"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="编码：">
          <el-input v-model="queryForm.factorCode" style="width: 140px"></el-input>
        </el-form-item>
        <el-form-item label="原编码：">
          <el-input v-model="queryForm.oldFactorCode" style="width: 140px"></el-input>
        </el-form-item>
        <el-form-item label="中文名称：">
          <el-input v-model="queryForm.factorName" style="width: 140px"></el-input>
        </el-form-item>
        <el-form-item>
  ...
  <!-- 因子列表 -->
    ...
    <el-table
      ...
      <el-table-column label="因子类型" show-overflow-tooltip>
        <template slot-scope="scope">
          {{ $enum.FactorsTypeList[scope.row.factorsType] }}
        </template>
      </el-table-column>
          ...
          <el-col :span="12">
            ...
            <el-form-item label="因子类型：" prop="factorsType">
              <el-select v-model="itemModel.factorsType">
                <el-option
                  v-for="(item, key) in $enum.FactorsTypeList"
                  :key="key"
                  :label="item"
                  :value="key - 0">
                </el-option>
          ...
          <el-col :span="12">
            ...
            <el-form-item label="所属类型：" prop="categoryList">
              <el-select v-model="itemModel.categoryList" multiple>
                <el-option
                  v-for="(item, key) in $enum.CategoryList"
                  :key="key"
                  :label="item"
                  :value="key - 0">
                </el-option>
            ...
            <el-form-item label="页面显示类型：" prop="showNameType">
              <el-select v-model="itemModel.showNameType">
                <el-option
                  v-for="(item, key) in $enum.showNameTypeList"
                  :key="key"
                  :label="item"
                  :value="key - 0">
                </el-option>
         ...
         <el-col :span="24">
            <el-form-item label="数据源：" prop="factorValueId">
              <el-select v-model.trim="itemModel.factorValueId" clearable>
                <el-option v-for="(item,index) in dict.FactorValueSource" :key="index"
...
import FactorSelect from './components/FactorSelectDialog';
import FactorSetting from './components/FactorSettingDialog';
