<template>
  <dialog-modal
    ...
    <el-table
      ...
      <el-table-column property="factorName" label="气体名称" min-width="100" show-overflow-tooltip></el-table-column>
      <el-table-column property="factorCode" label="气体编号" min-width="100" show-overflow-tooltip></el-table-column>
      <el-table-column property="factorType" label="气体类型" min-width="100" show-overflow-tooltip
      :formatter="changeOne"></el-table-column>
      <el-table-column property="unit" label="单位" min-width="100" show-overflow-tooltip></el-table-column>
      <el-table-column property="alertUpper" label="二级报警阀值" min-width="120" show-overflow-tooltip></el-table-column>
      <el-table-column property="earlyAlertUpper" label="一级报警阀值" min-width="120" show-overflow-tooltip>
      </el-table-column>
