  ...
  <dialog-modal
    ...
    >
      <el-form-item label="所属类型：" prop="factorType">
        <el-select v-model="itemModel.factorType" disabled @change="changeCode">
          <el-option :value="1" label="易燃易爆"></el-option>
          <el-option :value="2" label="有毒有害"></el-option>
          <el-option :value="3" label="其他"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="参数：" prop="factorCode">
        <el-select v-model="itemModel.factorCode" @change="changeName">
          <el-option
      ...
      <el-form-item label="二级报警阀值(高高限)：">
        <el-input v-model="itemModel.alertUpper"></el-input>
      </el-form-item>
      <el-form-item label="一级报警阀值(高限)：">
