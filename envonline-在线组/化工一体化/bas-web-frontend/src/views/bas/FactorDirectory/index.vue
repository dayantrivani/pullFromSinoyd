...
<template>
  <el-card>
    ...
    <el-table
      ...
      <el-table-column property="factorType" label="因子类型" width="120">
        <template slot-scope="scope">
          {{ $enum.FactorsType[scope.row.factorType] }}
        </template>
      </el-table-column>
      <el-table-column property="factorName" label="因子名称" width="150" show-overflow-tooltip></el-table-column>
      <el-table-column property="upperLimitValue" label="上限值" width="100" show-overflow-tooltip></el-table-column>
      <el-table-column property="lowerLimitValue" label="下限值" width="100" show-overflow-tooltip></el-table-column>
      <el-table-column property="unit" label="浓度单位" width="100"></el-table-column>
      <el-table-column property="cou" label="排放量" width="100"></el-table-column>
      <el-table-column property="couUnit" label="排放量单位" width="100"></el-table-column>
      <el-table-column property="outPutRuleValue" label="排放规律" width="120" show-overflow-tooltip></el-table-column>
      <el-table-column property="outPutRange" label="排放范围" width="120"></el-table-column>
      <el-table-column property="implementationCriteria" label="执行标准" width="120"></el-table-column>
      <el-table-column property="modifyDate" label="修改日期" width="100">
        <template slot-scope="scope">
    ...
    <!-- 编辑弹框 -->
    <dialog-form ref="dialog" :read-only="readOnly" @query="getItemList()" />
  </el-card>
</template>
  ...
  methods: {
    ...
    onClickExport() {
      ...
      this.$http.post('bas/pSCharacteristicPollutants/export', this.queryForm, {
        ...
        // const fileName = `污染物特征因子名录库${new Date().getTime()}.xls`;
