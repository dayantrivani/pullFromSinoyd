<template>
  <div class="g-login">
    <header>
      <div class="container">
        <img src="../../assets/loginImage/name.png" alt="图片加载失败">
      </div>
    </header>
    <main>
      <animates :time="500" effect="zoomIn" :position="true" speed="speed">
        <div class="login-box">
          <el-form class="login-form" ref="form" :model="loginForm" size="medium">
            <div>
              <div class="login-logo">
                <img style="width: 75%;" class="mar-t-xxl mar-b-lg" src="../../assets/loginImage/logo_login.png" alt="图片加载失败">
              </div>
