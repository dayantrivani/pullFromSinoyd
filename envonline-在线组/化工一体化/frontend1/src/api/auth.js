...
//   };
//   const keyParams = {
//     uid: crypto.AES.encrypt(params.uid, key, rules).toString(),
//     pid: crypto.AES.encrypt(params.pid, key, rules).toString(),
//   };
//   const data = { uid: keyParams.uid, pid: keyParams.pid };
// };
