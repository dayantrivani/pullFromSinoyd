<template>
  <dialog-modal ref="dialog"
    ...
    <el-table border
        ...
        <el-table-column property="analysisContent" header-align="center" label="安全分析" show-overflow-tooltip />
      </el-table>
      <!-- 分页 -->
...
export default {
  ...
  methods: {
    ...
    onSaveItem() {
      ...
      this.$http.post('wholeprocess/workAnalysis', tempArr).then((response) => {
