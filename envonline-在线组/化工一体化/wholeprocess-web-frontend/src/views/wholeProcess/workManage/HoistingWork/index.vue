        ...
        <el-form inline
          ...
          <el-row>
            <el-col :span="3"
              ...
              吊装作业开展中：{{count.inProgress}}个
            </el-col>
            <el-col :span="3"
                    style="color:#67C23A;font-size: 15px;font-weight: 550;">
              吊装作业完成数：{{count.completed}}个
            </el-col>
          ...
          <el-form :model="item"
            ...
            <el-row style="height:30px;">
              ...
              <el-col style=";margin-top:5px;"
                      :span="6">
                <el-form-item label="作业级别：">
                  <span v-if="item.workLevel === 1">一级吊装</span>
                  <span v-if="item.workLevel === 2">二级吊装</span>
                  <span v-if="item.workLevel === 3">三级吊装</span>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="吊装地点：">
                  <span>{{item.address}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="吊装工具：">
                  <span>{{item.hoistingToolName}}</span>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
...
export default {
  ...
  methods: {
    ...
    onClickExport() {
      ...
      this.$http.post('wholeprocess/hoistingWork/export', this.queryForm, {
        responseType: 'arraybuffer',
      }).then((response) => {
        // const fileName = decodeURI(response.headers['content-disposition']).split('=')[1];
        const fileName = `吊装作业${new Date().getTime()}.xls`;
