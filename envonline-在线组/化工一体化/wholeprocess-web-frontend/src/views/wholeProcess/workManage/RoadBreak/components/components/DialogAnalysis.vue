<template>
  <dialog-modal ref="dialog"
    ...
    <el-form ref="form"
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="安全分析：" prop="analysisContent">
            <el-input type="textarea"
                  :rows="4"
                  v-model="itemModel.analysisContent">
                </el-input>
          </el-form-item>
        </el-col>
      </el-row>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        analysisContent: [
          { required: true, message: '请输入安全分析', trigger: ['blur', 'change'] },
        ],
      },
    };
  },
