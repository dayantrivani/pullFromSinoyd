<template>
  <el-card fill>
    ...
    <div slot="header">
      <el-form inline
        ...
        <el-form-item label="安全动态主题："
                      prop="newsSubject">
          <el-input v-model="queryForm.newsSubject"></el-input>
        </el-form-item>
        <el-form-item label="发布人："
                      prop="newsPublisher">
          <el-input v-model="queryForm.newsPublisher"></el-input>
        </el-form-item>
        <el-form-item label="动态分类："
                      prop="newsType">
          <el-select v-model="queryForm.newsType"
                     autofocus
                     clearable>
    ...
    <el-table border
      ...
      <el-table-column property="newsSubject"
                       label="安全动态主题"
                       min-width="100"
                       show-overflow-tooltip>
      </el-table-column>
      <el-table-column property="newsType"
                       label="动态分类"
                       min-width="100"
                       show-overflow-tooltip>
        <template slot-scope="scope">{{$enum.getLabel('NEWSTYPE',scope.row.newsType)}}</template>
      </el-table-column>
      <el-table-column property="newsPublisher"
                       label="发布人"
                       min-width="100"
                       show-overflow-tooltip>
      </el-table-column>
