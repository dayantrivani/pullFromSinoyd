<template>
  <el-card fill>
    ...
    <div slot="header">
      <el-form inline
        ...
        <el-form-item label="活动级别："
                        prop="activityLevel">
            <el-select v-model="queryForm.activityLevel"
                       autofocus
                       clearable>
    ...
    <el-table border
      ...
      <el-table-column property="activityTime"
                       label="活动时间"
                       min-width="100"
                       show-overflow-tooltip>
      </el-table-column>
      ...
      <el-table-column property="activityLevel"
                       label="活动级别"
                       min-width="150"
                       show-overflow-tooltip>
        <template slot-scope="scope">{{$enum.getLabel('RESPONSIBLE_LEVEL',scope.row.activityLevel)}}</template>
      </el-table-column>
