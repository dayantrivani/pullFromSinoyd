    ...
    <dialog-modal title="评价值信息" ref="dialogForm" @close="onCloseForm">
      <el-form
        ...
        <el-form-item label="表达式：">
          ...
          <hint-text class="mar-b-0" label="例：">>50 或者 &lt;100  或者 6~9</hint-text>
        </el-form-item>
...
<script>
import LevelDialog from '@/views/cfg/CommonDialog/EvaluateLevelDialog';
import FactorDialog from '@/views/cfg/CommonDialog/EvaluateFactorDialog';
...
export default {
  ...
  methods: {
    ...
    //   console.log(this.itemModel, row, column);
    //   this.$refs.dialogForm.openDialog();
    // },
    // 点击编辑
    onCellClick(row, column) {
      // console.log(row, column, row[column.label]);
      this.itemModel = {
        ...row[column.label],
        levelId: row.levelId,
