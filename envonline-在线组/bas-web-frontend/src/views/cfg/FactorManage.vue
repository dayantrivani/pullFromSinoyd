<template>
    ...
    <div slot="header">
      <el-form inline :model="queryForm">
        <el-form-item label="因子名称：">
          <el-input v-model="queryForm.factorName" style="width: 150px" placeholder="因子名称" clearable></el-input>
        </el-form-item>
        <el-form-item>
  ...
  <!-- 分页 -->
    ...
    <dialog-modal ref="dialog" size="mini" :title="`${isEdit ? '编辑' : '新增'}因子信息`" :before-close="onCloseDialog">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button size="small" @click="onCloseDialog()">
