<template>
  ...
  <el-card fill>
    ...
    <el-table
      ...
      <el-table-column prop="chimneyNo" label="烟囱编码" show-overflow-tooltip></el-table-column>
    ...
    <dialog-modal ref="dialog" title="烟囱设施信息" @close="onDialogClose">
      <el-form ref="chimneyForm" :model="chimneyModel" label-width="130px" :rules="rules">
        <el-row :gutter="10">
          <el-col :span="12">
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="高度：" prop="chimneyHigh">
              <el-input-number
                v-model="chimneyModel.chimneyHigh"
          ...
          <el-col :span="12">
            <el-form-item label="出口内径：" prop="chimneyDiameter">
              <el-input-number
                v-model="chimneyModel.chimneyDiameter"
                controls-position="right"
                :min="0"
                :max="2147483647"
                style="width: 100%;">
          ...
          <el-col :span="12">
            <el-form-item label="排口类型：" prop="chimneyTypeId">
              <el-select v-model="chimneyModel.chimneyTypeId" style="width:100%">
                <el-option v-for="(item,index) in $hp.PortTypeList" :key="index"
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="关停并转日期：" prop="stopTime">
              ...
              v-model="chimneyModel.stopTime" type="date" style="width:100%"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="排放规律：" prop="letRuleId">
              <el-select v-model="chimneyModel.letRuleId" filterable style="width:100%">
                <el-option v-for="(item,index) in dropDownList.OutputRule" :key="index"
          ...
          <el-col :span="12">
            <el-form-item label="气域功能区类别：" prop="functionAreaId">
              <el-select v-model="chimneyModel.functionAreaId" filterable style="width:100%">
                <el-option v-for="(item,index) in dropDownList.AirFunctionArea" :key="index"
                  :label="item.dictName" :value="item.rowGuid"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="标志牌安装形式：" prop="flagInstallFormId">
              <el-select v-model="chimneyModel.flagInstallFormId" filterable style="width:100%">
                <el-option v-for="(item,index) in dropDownList.FlagInstallForm" :key="index"
                  :label="item.dictName" :value="item.rowGuid"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="两控区类型：" prop="twoAreaTypeId">
              <el-select v-model="chimneyModel.twoAreaTypeId" filterable style="width:100%">
                <el-option v-for="(item,index) in dropDownList.DoubleControlType" :key="index"
                  :label="item.dictName" :value="item.rowGuid"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" icon="fas fa-save" :loading="saveLoading" @click="onSaveChimney">保 存</el-button>
...
export default {
  ...
  methods: {
    ...
    getItemList() {
      this.loading = true;
      this.$http.get('bas/chimney', { params: { ...this.pager, psId: this.activeInfo.id } }).then((response) => {
    ...
    onSaveChimney() {
      this.$refs.chimneyForm.validate((valid) => {
        ...
        this.chimneyModel.psId = this.activeInfo.id;
