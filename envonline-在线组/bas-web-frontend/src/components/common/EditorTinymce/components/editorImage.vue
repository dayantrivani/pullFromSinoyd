<template>
  <div>
    <el-button icon="fas fa-cloud-upload-alt-alt" @click="dialogVisible = true">上传图片</el-button>
    <el-dialog title="图片上传" :visible.sync="dialogVisible" :close-on-click-modal="false">
      ...
      <div slot="footer" class="text-right">
        <el-button type="primary" class="fas fa-cloud-upload-alt-alt" @click="handleSubmit">上传</el-button>
