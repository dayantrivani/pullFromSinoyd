<template>
  ...
  <div style="height: 100%">
    ...
    >
      ...
      <el-table-column label="步骤" prop="procName" min-width="100" show-overflow-tooltip></el-table-column>
      <el-table-column label="处理部门" prop="processDept" min-width="120" show-overflow-tooltip></el-table-column>
      <el-table-column label="处理人员" prop="processPerson" min-width="80" show-overflow-tooltip></el-table-column>
      <el-table-column label="工号" prop="employeeNo" min-width="120" show-overflow-tooltip></el-table-column>
      <el-table-column label="操作" prop="operate" min-width="80" show-overflow-tooltip></el-table-column>
      <el-table-column label="收到时间" prop="acceptTime" min-width="160" show-overflow-tooltip></el-table-column>
      <el-table-column label="处理时间" prop="processTime" min-width="160" show-overflow-tooltip></el-table-column>
      <el-table-column label="处理时长" prop="processDuration" min-width="160" show-overflow-tooltip></el-table-column>
