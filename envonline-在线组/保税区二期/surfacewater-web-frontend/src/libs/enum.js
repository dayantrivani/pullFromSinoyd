...
const enums = {
  ...
  alarmCodeType: {
    StorageTankTemperatureAlarm: '储罐温度报警',
    StorageTankPressureAlarm: '储罐压力报警',
    StorageTankLiquidLevelAlarm: '储罐液位报警',
    CombustibleGasAlarm: '可燃气体报警',
    ToxicGasAlarm: '有毒有害气体报警',
    ProcessAbnormalAlarm: '危险工艺报警',
  },
