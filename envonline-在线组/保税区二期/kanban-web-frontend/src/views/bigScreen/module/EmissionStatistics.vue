<template>
  <div class="emission-statistics">
    <board-box title="胜科水务排放量统计">
      ...
      <div ref="echart" style="height: calc(100% - 0.3rem)" :class="{ 'empty-box': isEmpty }"></div>
    </board-box>
  </div>
</template>

<script>
import boardBox from '../components/bsBoardBox';
...
export default {
        ...
        series: [
          {
            ...
            label: {
              show: true,
              formatter: (parms) => {
                const val = `${(this.option.series[1].data[parms.dataIndex] / this.option.series[0].data[parms.dataIndex]).toFixed(2)}%`;
                return val;
              },
            },
            itemStyle: {
  ...
  methods: {
    ...
    getItemList() {
      this.itemData = {
        data: ['2019.5', '2019.6', '2019.7', '2019.8', '2019.9', '2019.10', '2019.11', '2019.12', '2020.1', '2020.2', '2020.3', '2020.4'],
        standardData: [2, 3, 0, 0, 3, 1, 5, 5, 1, 1, 2, 2],
        substandardData: [2, 3, 0, 0, 3, 1, 5, 5, 1, 1, 2, 2],
        totalData: [2, 7, 0, 0, 3, 1, 5, 5, 1, 1, 2, 2],
        totalRate: 98,
      };
