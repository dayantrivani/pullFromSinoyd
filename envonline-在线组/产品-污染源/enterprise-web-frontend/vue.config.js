...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      // 常规接口
      '/api/sinoyd-wrybase': {
        target: 'http://olp4.dev.yd/api/sinoyd-wrybase',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-wrybase': '',
      ...
      // 登录接口
      '/api/proxy': {
        target: 'http://olp4.dev.yd/api/proxy',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/proxy': '',
      ...
      // 侧边导航树接口
      '/api/sinoyd-frame': {
        target: 'http://olp4.dev.yd/api/sinoyd-frame',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-frame': '',
      ...
      '/api/sinoyd-doc': {
        ...
        target: 'http://olp4.dev.yd/api/sinoyd-doc',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-doc': '',
      ...
      // 存储接口
      '/storage': {
        target: 'http://192.168.11.65:9099/storage/',
        changeOrigin: true,
        pathRewrite: {
          '^/storage': '',
        },
      ...
      '/api/sinoyd-keypoints': {
        target: 'http://olp4.dev.yd/api/sinoyd-keypoints',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-keypoints': '',
      ...
      // 能耗接口
      '/api/sinoyd-eec': {
        target: 'http://olp4.dev.yd/api/sinoyd-eec',
        changeOrigin: true,
        autoRewrite: true,
        pathRewrite: {
          '^/api/sinoyd-eec': '',
