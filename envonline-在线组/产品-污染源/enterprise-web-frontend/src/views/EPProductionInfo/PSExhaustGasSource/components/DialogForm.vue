<template>
  <dialog-modal
    ...
    <el-form
      ...
      <el-form-item label="废气源名称：" prop="exhaustGasSourceName">
        <el-input
          v-model="itemModel.exhaustGasSourceName"
          clearable></el-input>
      </el-form-item>
      <el-form-item label="废气源编码：">
        <el-input
          v-model="itemModel.exhaustGasSourceCode"
          clearable></el-input>
      </el-form-item>
      ...
      <el-form-item label="收集方式：">
        <el-select v-model="itemModel.collectionMethod">
          <el-option
...
export default {
  ...
  data() {
    return {
      saveLoading: false,
      url: 'bas/psExhaustGasSource',  // 必须, 接口地址
      psName: '',
      itemModel: {
        id: '',
        psId: '',
        exhaustGasSourceName: '',
        exhaustGasSourceCode: '',
        sourceCategory: '',
        collectionMethod: '',
        remark: '',
      },          // 表单对象
      formRules: {
        ...
        exhaustGasSourceName: [
          { required: true, message: '请输入废气源名称', trigger: ['blur', 'change'] },
        ],
      },
    };
  },
