<template>
  ...
  <div style="height: calc(100% - 40px);">
    ...
    <el-table
      ...
      <el-table-column property="tstamp" min-width="160" label="留样开始时间" show-overflow-tooltip>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getItemList() {
      ...
      this.$http.post('autoSample/overProofSample', this.queryForm, {
        params: {
          page,
          rows,
        },
    ...
    onExport() {
      ...
      this.$http.post('autoSample/overProofSample/export/0', {
        ...this.queryForm,
        factorList,
      }, {
        responseType: 'arraybuffer',
      }).then((response) => {
        const fileName = `留样-超标留样数据${new Date().getTime()}.xls`;
