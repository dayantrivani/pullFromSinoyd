  ...
  <el-card>
    ...
    <div class="mar-l-sm mar-y-xs">
      ...
      <el-button
        ...
        @click="onDeleteItem(getItemList)">删 除
      </el-button>
    </div>
    ...
    >
      ...
      <el-table-column label="申报时间" prop="applyTime" min-width="160" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column label="状态" min-width="70" show-overflow-tooltip>
        <template slot-scope="{ row }">
          <span>{{$enum.getLabel('VALVE_CHECK_STATUS', row.status)}}</span>
        </template>
      </el-table-column>
      <el-table-column label="处理意见" prop="dealRemark" min-width="145" show-overflow-tooltip></el-table-column>
      <el-table-column label="处理时间" prop="dealTime" min-width="160" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      queryForm: {                  // 检索表单项
        psId,
        fromDate: getDay(-1, false, false),  // 开始时间
