<template>
  <container class="Page-AutoScoreConfig">
...
import { emptyQuery, getList } from '@/api/modules/auto-score-config.js';
import { remove } from '@/api/modules/auto-score-config.js';
