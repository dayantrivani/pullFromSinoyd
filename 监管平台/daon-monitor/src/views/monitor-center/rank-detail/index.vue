        ...
        <a-form layout="inline">
          ...
          <a-form-item class="mar-r-0">
            <a-input-search
              ...
              style="width: 220px"
              @search="onQueryList"
              placeholder="请输入企业名称" allowClear>
      ...
      >
        ...
        <template slot="operation" slot-scope="text, record">
          <i @click="onEditClick(record)">
            <icon name="icon-xiangqingchakan" customClass="iconClass" size="14px"></icon>
          </i>
        </template>
      </a-table>
...
import { emptyQuery, getList } from '@/api/modules/rank-detail.js';
