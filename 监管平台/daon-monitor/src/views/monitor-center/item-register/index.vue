<template>
  <container class="Page-ItemRegister">
        ...
        <a-form layout="inline">
          ...
          <a-form-item class="mar-r-0">
            <a-input-search
              ...
              @search="onQueryList"
              style="width: 220px" placeholder="请输入企业名称" allowClear>
    ...
    <a-card :bordered="false">
      ...
      <a-table
        ...
        @change="_change"
      >
        <template slot="cycleSlot" slot-scope="text">
          第{{periodName[text - 1]}}周期
        </template>
...
import {
  emptyQuery, getList, remove,
} from '@/api/modules/item-register.js';
...
export default {
  ...
  data() {
    return {
      periodName: ['一', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '十二'], // 周期数转中文
      loading: {
        spinning: false,
        tip: '数据加载中',
      },
      ...
      columns: [
        ...
        },
        {
          ...
          key: 'periodIndex',
          scopedSlots: { customRender: 'cycleSlot' },
        },
        {
          title: '企业名称',
